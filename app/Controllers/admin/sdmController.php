...
class sdmController extends BaseController
{
    public function index(): string
    {
        ...
        return view('admin/sdm/index', $data);
    }
    ...
    public function master_cuti(): string
    {
        ...
        return view('admin/sdm/master_cuti/index', $data);
    }
    ...
    public function master_riwayat_cuti(): string
    {
        ...
        return view('admin/sdm/master_cuti/master_riwayat_cuti/index', $data);
    }
    ...
    public function master_izin(): string
    {
        ...
        return view('admin/sdm/master_izin/index', $data);
    }
    ...
    public function master_riwayat_izin(): string
    {
        ...
        return view('admin/sdm/master_izin/master_riwayat_izin/index', $data);
    }
    ...
    public function master_employee(): string
    {
        ...
        return view('admin/sdm/master_employee/index', $data);
    }
    ...
    public function general(): string
    {
        ...
        return view('admin/sdm/master_employee/tambah', $data);
    }
    ...
    public function edit_general(): string
    {
        $data['judul'] = 'Bintang Distributor';
        $data['judul1'] = 'INFORMATION EMPLOYEE';
        return view('admin/sdm/master_employee/edit', $data);
    }
    ...
    public function report_data_karyawan(): string
    {
        $data['judul'] = 'Bintang Distributor';
        $data['judul1'] = 'INFORMATION EMPLOYEE';
        return view('admin/sdm/master_employee/pdf', $data);
    }
    ...
    public function master_absen_gaji(): string
    {
        ...
        return view('admin/sdm/master_absen_gaji/index', $data);
    }
    ...
    public function master_perbaikan_absen(): string
    {
        ...
        return view('admin/sdm/master_absen_gaji/master_perbaikan_absen/index', $data);
    }
    ...
    public function form_absensi(): string
    {
        ...
        return view('admin/sdm/master_absen_gaji/cetak_absensi/index', $data);
    }
    ...
    public function master_absen(): string
    {
        ...
        return view('admin/sdm/master_absen/index', $data);
    }
