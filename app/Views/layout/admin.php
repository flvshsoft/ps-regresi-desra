    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:#436850 ">
            <ul class="nav pt-4">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link text-black"
                                    href="<?= base_url('/admin/luas_wilayah') ?>"> Luas Wilayah</a></li>
                            <li class="nav-item"> <a class="nav-link text-black"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#regresi" aria-expanded="false"
                        aria-controls="regresi">
                    ...
                    <div class="collapse" id="regresi">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link text-black"
                                    href="<?= base_url('/admin/training') ?>"> Training</a></li>
                            <li class="nav-item"> <a class="nav-link text-black"
                                    href="<?= base_url('/admin/testing') ?>"> Testing & MAPE</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#usertest" aria-expanded="false"
                        aria-controls="usertest">
                        <i class="mdi mdi-server-network menu-icon text-whitex text-shadow"></i>
                    ...
                    <div class="collapse" id="usertest">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link text-black"
                                    href="<?= base_url('/admin/user_testing/regresi') ?>"> Regresi Linear</a></li>
                            <li class="nav-item"> <a class="nav-link text-black" href="<? //= base_url(/admin/user_testing/ses) 
                                                                                        ?>"> Single Exponen S </a></li>
                            <li class="nav-item"> <a class="nav-link text-black"
                                    href="<?= base_url('/admin/riwayat') ?>"> Riwayat</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
