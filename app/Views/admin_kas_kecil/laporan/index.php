                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="template-demo">
                            <div class="menu-item">
                                <a href="<?= base_url('/form_report_assets') ?>"> <i
                            ...
                            <hr>
                            <div class="menu-item">
                                <a href="<?= base_url('/form_cetak_labarugi') ?>">
                            ...
                            <hr>
                            <div class="menu-item">
                                <a href="<?= base_url('/form_print_pengeluaran') ?>">
                            ...
                            <hr>
                            <div class="menu-item">
                                <a href="<?= base_url('/form_report_sales') ?>">
                                    <i class="mdi mdi-file-document menu-icons"></i>
                            ...
                            <hr>
                            <div class="menu-item">
                                <a href="<?= base_url('/form_cost_ratio') ?>">
