    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('/akk/transaksi/ambil_barang/detail/' . $id_sales['id_sales']) ?>">
                            Detail</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/akk/transaksi/ambil_barang/detail/tambah') ?>">
                            <div class="form-group row mb-0">
                                <div class="col-sm-9">
                                    <input type="hidden" name="id_sales" value="<?= $id_sales['id_sales'] ?>" class="form-control form-control-sm">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="id_price_detail" id="id_product" class="form-control">
                                        ...
                                        <?php foreach ($product as $value) { ?>
                                            <option value="<?= $value['id_price_detail'] ?>">
                            ...
                            <div class="form-group mb-0 text-center">
                                ...
                                <a href="<?= base_url('/akk/transaksi/ambil_barang/detail/' . $id_sales['id_sales']) ?>" class="btn btn-light btn-xs">
