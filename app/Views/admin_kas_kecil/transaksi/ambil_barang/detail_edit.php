    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('/akk/transaksi/ambil_barang/detail/' . $model['id_sales']) ?>">
                            Detail</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/akk/transaksi/ambil_barang/detail/edit') ?>">
                            <div class="form-group row mb-0">
                                <div class="col-sm-9">
                                    <input type="hidden" name="id_sales" value="<?= $model['id_sales'] ?>" class="form-control form-control-sm">
                                    <input type="hidden" name="id_sales_detail" value="<?= $model['id_sales_detail'] ?>" class="form-control form-control-sm">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="<?= $model['satuan_sales_detail'] ?>" name="satuan_sales_detail">
                                </div>
                            </div>
                            <div class="form-group mb-0 text-center">
                                ...
                                <a href="<?= base_url('/akk/transaksi/ambil_barang/detail/' . $model['id_sales']) ?>" class="btn btn-light btn-xs">
