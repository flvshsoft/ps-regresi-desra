                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style=" font-size: 11px;">
                                                <b>
                                                    <a style="text-decoration:none" href="<?= base_url('/akk/form_customer/' . $value['id_nota_detail']) ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    ...
                                    <form method="POST" action="<?= base_url('/akk/transaksi/tagihan_baru/nota/detail') ?>">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="satuan_penjualan" class="form-control form-control-sm" placeholder="0">
                                                <input type="hidden" name="id_nota" class="form-control form-control-sm" value="<?= $nota['id_nota'] ?>">
                                            </td>

                                            <td style=" font-size: 11px;">
                                                <input type="text" name="diskon_penjualan" class="form-control" placeholder="0">
                                            </td>
                                            <td style=" font-size: 11px;">
            ...
            <form class="forms-sample" action="<?= base_url('/akk/transaksi/tagihan_baru/nota/detail/edit') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="hidden" class="form-control" value="<?= $detail['id_nota_detail'] ?>" name="id_nota_detail">
                            <select class="form-control" name="id_sales_detail">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?= $detail['satuan_penjualan'] ?>" name="satuan_penjualan">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?= $detail['diskon_penjualan'] ?>" name="diskon_penjualan">
