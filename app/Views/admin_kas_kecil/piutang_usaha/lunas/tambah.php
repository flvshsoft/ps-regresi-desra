                            ...
                            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                <thead class="table table-primary">
                                    <tr>
                                        ...
                                        <th style="font-size: 11px;" width="190px"> Tunai <input type="checkbox" id="checkall" class="form-check-input"></th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <form method="POST" action="<?= base_url('/akk/add_piutang') ?>">
                                                ...
                                                <td style="font-size: 11px;" width="190px" class="text-center">
                                                    <input type="checkbox" name="myCheckbox" id="myCheckbox" class="form-check-input">
                                                    </label>
                                                </td>
                                                <td style="font-size: 11px;">
                                                    <div class="justify-content-center text-center">
                                                        <button type="submit" id="submitButton" class="btn btn-success btn-xs">
                                                            S
                                                        </button>
                                                    </div>
                                                </td>
