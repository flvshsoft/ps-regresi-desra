                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group">
                                <a class="btn btn-success btn-xs" href="<?= base_url('/akk/form_piutang') ?>">
                                    <i class="mdi mdi-database-plus icon-sm"></i> Piutang Intern</a>
                                <a class="btn btn-warning btn-xs" href="<?= base_url('/akk/input_piutang') ?>">
                                    <i class="mdi mdi-cash-usd icon-sm"></i> Tunai</a>
                                <a class="btn btn-danger btn-xs" href="<?= base_url('/akk/input_piutang_kredit') ?>">
