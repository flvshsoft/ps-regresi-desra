                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                <a class="btn btn-gradient-success btn-xs btn-icon-text my-1" href="<?= base_url('/akk/supplier') ?>">
                                    <i class="mdi mdi-database-plus icon-sm"></i> Input Supplier</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-sm table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                <thead class="table table-primary">
                                    <tr>
                                        ...
                                        <th style="font-size: 11px;"> Kode Supplier </th>
                                        <th style="font-size: 11px;"> Nama Supplier </th>
