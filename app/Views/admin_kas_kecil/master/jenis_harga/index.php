                    ...
                    <div class="card-body">
                        <div class="form-group col-12">
                            <a class="btn btn-gradient-success btn-xs btn-icon-text my-1" data-bs-toggle="modal"
                                ...
                                <i class=" mdi mdi-database-plus icon-sm"></i> Input Jenis Harga</a>
                        </div>
                                        ...
                                        <td style="font-size: 11px;">
                                            <div class="justify-content-center">
                                                <a onclick="return confirm('Anda Yakin Ingin Menghapusnya?')"
                                                    href="<?= base_url('/akk/del_jenis_harga/' . $value['id_jenis_harga']) ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Jenis Harga</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="forms-sample" action="<?= base_url('/akk/input_jenis_harga') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Remark Jenis Harga</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="exampleInputUsername2"
                                name="remark_jenis_harga">
                        </div>
                    </div>
                </div>
