                    ...
                    <div class="card-body">
                        <div class="template-demo">
                            <td class="menu-item" style="vertical-align:middle;">
                                <b>
                                    <a style="text-decoration:none;color:black;" href="<?= base_url('/akk/pengeluaran_kantor') ?>">
                            ...
                            <td class="menu-item" style="vertical-align:middle;">
                                <b>
                                    <a style="text-decoration:none;color:black;" href="<?= base_url('/akk/master_pengeluaran') ?>">
                            ...
                            <td class="menu-item" style="vertical-align:middle;">
                                <b>
                                    <a style="text-decoration:none;color:black;" href="<?= base_url('/akk/master_cash_receipt') ?>">
                            ...
                            <td class="menu-item" style="vertical-align:middle;">
                                <b>
                                    <a style="text-decoration:none;color:black;" href="<?= base_url('/akk/kas_kecil') ?>">
                            ...
                            <td class="menu-item" style="vertical-align:middle;" width="20px">
                                <b>
                                    <a style=" text-decoration:none;color:black;" href="<?= base_url('/akk/mutasi_bank') ?>">
                            ...
                            <td class="menu-item" style="vertical-align:middle;">
                                <b>
                                    <a style="text-decoration:none;color:black;" href="<?= base_url('/akk/master_giro') ?>">
