    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-9 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/admin/data_kecamatan/edit') ?>">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?= $model['kode_kecamatan'] ?>"
                                        class="form-control form-control-sm" disabled>
                                    <input type="hidden" value="<?= $model['kode_kecamatan'] ?>"
                                        class="form-control form-control-sm" name="kode_kecamatan">
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?= $model['nama_kecamatan'] ?>"
                                        class="form-control form-control-sm" name="nama_kecamatan">
                                </div>
                            </div>
                            <div class="form-group text-center mb-0">
                                <button type="submit" class="btn btn-success btn-xs"><i
                                        class="mdi mdi-content-save-all icon-sm"></i></button>
                                <a class="btn btn-light btn-xs" href="<?= base_url('/admin/data_kecamatan') ?>"><i
