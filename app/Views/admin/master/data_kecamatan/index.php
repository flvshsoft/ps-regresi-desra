                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                <a class="btn btn-gradient-success btn-xs btn-icon-text my-1" href="<?= base_url('/admin/data_kecamatan/tambah') ?>">
                            ...
                            <table class="table table-sm table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                <thead class="table table-primary">
                                    <tr>
                                        ...
                                        <th style="font-size: 11px;"> Kode Kecamatan </th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($model as $value) { ?>
                                        <tr>
                                            ...
                                            <td style="font-size: 11px;">
                                                <b>
                                                    <a style="text-decoration:none" href="<?= base_url('/admin/data_kecamatan/edit/' . $value['kode_kecamatan']) ?>">
                                            ...
                                            <td style="font-size: 11px;">
                                                <a onclick="return confirm('Anda Yakin Ingin Menghapusnya?')" href="<?= base_url('/admin/data_kecamatan/hapus/' . $value['kode_kecamatan']) ?>">
