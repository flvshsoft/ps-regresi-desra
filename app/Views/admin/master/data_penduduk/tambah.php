    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-9 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/admin/data_penduduk/tambah') ?>">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" name="tahun" placeholder="Tahun">
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" name="luas_wilayah" placeholder="Luas Wilayah">
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" name="jumlah_penduduk" placeholder="Jumlah Penduduk">
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="int" class="form-control form-control-sm" name="kepadatan_penduduk" placeholder="Kepadatan Penduduk">
                                </div>
                            </div>
                            <div class="form-group text-center mb-0">
                                <button type="submit" class="btn btn-success btn-xs"><i class="mdi mdi-content-save-all icon-sm"></i></button>
                                <a class="btn btn-light btn-xs" href="<?= base_url('/admin/data_penduduk') ?>"><i class="mdi mdi-backburger icon-sm"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
