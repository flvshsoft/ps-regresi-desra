    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('/akk/detail_price/' . $id_price['id_price']) ?>">
                            Detail</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/akk/save_detail_price') ?>">
                            <div class="form-group row mb-0">
                                <div class="col-sm-9">
                                    <input type="hidden" name="id_price" value="<?= $id_price['id_price'] ?>"
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <select required name="id_product" id="id_product" class="form-control">
                                        <option> Pilih </option>
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input required type="text" id="nama_product" disabled
                                        class="form-control form-control-sm">
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0 text-center">
                                ...
                                <a href="<?= base_url('/akk/detail_price/' . $id_price['id_price']) ?>"
