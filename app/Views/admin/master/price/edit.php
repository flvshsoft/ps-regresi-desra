    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-9 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/akk/update_price') ?>">

                            <div class="form-group row mb-0">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Keterangan
                                </label>
                                <div class="col-sm-9">
                                    <input type="hidden" class="form-control form-control-sm" name="id_price" value="<?= $model['id_price'] ?>">
                                    <input type="text" class="form-control form-control-sm" name="keterangan_price" value="<?= $model['keterangan_price'] ?>">
                                </div>
